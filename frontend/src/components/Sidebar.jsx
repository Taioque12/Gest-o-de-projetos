  ...
  return (
    <aside className="sidebar">
      ...
      <nav className="side-nav">
        <div className={`side-item ${view === 'dashboard' ? 'active' : ''}`} onClick={() => navigate('/dashboard')} title="Dashboard">
        ...
        <div className="side-item" title="Folders">
        ...
        <div className="side-item" title="Tasks">
        ...
        <div className={`side-item ${view === 'equipes' ? 'active' : ''}`} onClick={() => navigate('/equipes')} title="Equipes">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
        </div>
        <div className="side-item" title="Analytics">
        ...
        <div className={`side-item ${view === 'acessos' ? 'active' : ''}`} onClick={() => navigate('/acessos')} title="Acessos / Configurações">
      ...
      <div className="side-avatar">
        <div style={{ position: 'relative' }}>
          <img src="https://ui-avatars.com/api/?name=Alex+R&background=0D8ABC&color=fff" alt="User" />
          <div style={{ width: 8, height: 8, background: '#22c55e', borderRadius: '50%', position: 'absolute', top: 0, right: -2, border: '2px solid #11141c' }} />
        </div>
        <span>Alex R.</span>
      </div>
    </aside>
